...
var FilenameGenerator = require('./filename-generator/filename-generator');
var makeRequest = require('./request');
var getResourceHandler = require('./file-handlers');
var FSAdapter = require('./fs-adaper');
var utils = require('./utils');

function createFilenameGenerator (options) {
	var supportedOptions = ['filenameGenerator', 'subdirectories', 'defaultFilename'];
	return new FilenameGenerator(_.pick(options, supportedOptions));
}
...
function Scraper (options) {
	...
	self.filenameGenerator = createFilenameGenerator(self.options);
