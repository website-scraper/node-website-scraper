...
import { extend, clone, union, urlsEqual, getTypeByMime, getTypeByFilename } from './utils/index.js';
...
class Scraper {
	...
	scrape () {
		return Promise.bind(this)
			.then(() => this.runActions('beforeStart', {options: this.options, utils: {}})) // todo: fix utils
			.then(this.load)
...
// todo: use new export for plugins
// Scraper.plugins = {
// 	SaveResourceToFileSystemPlugin,
// 	GenerateFilenameByTypePlugin,
// 	GenerateFilenameBySiteStructurePlugin
