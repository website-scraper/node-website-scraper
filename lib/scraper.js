...
const ResourceStorage = require('./resource-storage');
...
function Scraper (options) {
	...
	self.resourceStorage = self.options.resourceStorage ? new self.options.resourceStorage(self.options) : new ResourceStorage(self.options);
...
Scraper.prototype.saveResource = function saveResource (resource) {
	...
	return Promise.resolve()
		.then(function handleResource () {
			...
			return self.resourceStorage.saveResource(resource);
