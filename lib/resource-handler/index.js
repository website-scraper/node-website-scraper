...
import {getUrl, prettifyFilename, getHashFromUrl, waitAllFulfilled} from '../utils/index.js';
...
class ResourceHandler {
	...
	downloadChildrenResources (pathContainer, parentResource) {
		...
		return waitAllFulfilled(childrenPromises).then(function updateChildrenPaths () {
