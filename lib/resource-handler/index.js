...
/**
 * Download resource
 * @param PathContainer - class of PathContainer - imgSrcsetTag or CommonTag or CssText
 * @param {Resource} parentResource
 * @param {string} text
 * @param {HtmlData} [childResourceHtmlData]
 * @returns {Promise}
 */
ResourceHandler.prototype.handleChildrenResources = function handleChildrenResources (PathContainer, parentResource, text, childResourceHtmlData) {
	var self = this;
	var pathContainer = new PathContainer(text);
